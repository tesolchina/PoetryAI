...
Figure 1: Three Interaction Types in AI-Assisted L2 Poetry Writing
...
We traces three data sources throughout the experiment: (1) **Chat transcripts**—interactional patterns; (2) **Panel discussion**—spontaneous reflection from participants; (3) **Feedback template**—systematic measurement of authorship, satisfaction, and interaction type preferences.
...
Figure 2: Interaction Type Distribution by Parameter Configuration
...
Figure 3: Authorship and Satisfaction by Parameter Configuration
...
Figure 4: Type C Presence Predicts Authorship and Satisfaction Outcome
...
Chat transcripts from Room B (low-temperature) contained no comparable Type C moments. Instead, interactions remained confined to predictable patterns: Type B exemplar provision (AI offering 2-4 line options such as “Here are a few options based on your dream...”) and Type A minor corrections. The absence of unexpected creative pivots resulted in qualitatively different collaborative experiences.
