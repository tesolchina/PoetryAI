...
### 1.2 L2 Creative Writing Scaffolding: The Need for Adaptive Support
...
### 1.3 AI-Assisted Poetry Writing: Emerging Research and Pedagogical Considerations

The use of generative AI for poetry writing represents an emerging area of research with rapidly evolving pedagogical implications. Several recent studies illuminate both the potential and challenges of AI in this domain:

#### AI-Generated Poetry as Writing Model

Chakrabarty, Padmakumar, and He (2022) developed an instruction-tuning approach for collaborative poetry writing with large language models, demonstrating how AI can provide diverse stylistic models and prompt learners to articulate poetic choices explicitly. Their work suggests AI systems can serve as interactive partners that help writers clarify and defend aesthetic decisions—supporting the metacognitive dimensions of creative writing (Kellogg & Whiteford, 2009).

#### Human-AI Co-Creativity

Coenen et al. (2022) conducted empirical investigation of human-AI co-creativity in writing through their Wordcraft platform, identifying **serendipitous discovery** as a key affordance—unexpected AI suggestions can trigger creative insights that solitary writing might not generate (Boden, 2004). Critically, they found that **interaction quality matters more than interface design**: the type of human-AI exchange (collaborative vs. directive) shaped creative outcomes more than presentation format.

#### Parameter Sensitivity in Language Generation

Recent technical research (Li et al., 2025; Peeperkorn et al., 2024; Holtzman et al., 2019) reveals that temperature and top-p settings systematically shape generation characteristics. Lower temperatures generate conventional, corpus-typical outputs aligned with training data distributions; higher temperatures increase variability and novelty. However, **the pedagogical implications of these technical parameters remained largely unexplored** until recently—this study addresses that gap by examining how parameter configuration shapes interaction patterns in educational contexts.

#### AI's Capacity for Pattern Recognition and Manipulation

Large language models demonstrate sophisticated capacity to recognize and manipulate linguistic patterns at multiple levels—phonetic, syntactic, semantic, and aesthetic. LLMs trained on vast corpora of diverse poetry internalize patterns of poetic form, sound, structure, and meaning-making without explicit instruction about meter, rhyme, or prosody (Holtzman et al., 2019). This pattern-recognition capability parallels what experimental poets like Charles Bernstein explore in his poetry collections, where conscious manipulation of sonic texture, line breaks, and syntactic disruption create meaning through form itself. AI systems can recognize these patterns and apply them generatively to novel compositions, enabling writers to experiment with forms and effects they might not have mastered through traditional study alone. Critically, AI can do this across multiple poetic dimensions simultaneously—managing rhythm while maintaining semantic coherence, manipulating sound patterns while preserving emotional resonance. This multidimensional pattern-handling capacity potentially transforms AI from a tool for generating thematic content into a sophisticated resource for exploring how form and pattern create aesthetic and emotional effects—a dimension particularly valuable for L2 learners developing sensitivity to English's linguistic and poetic patterns.

However, existing AI poetry research predominantly investigates **what** generative AI can produce—whether it generates coherent poetry, how human readers perceive AI-generated versus human-authored poetry, and **to what extent** AI approximates literary quality. This focus reflects foundational questions about AI capabilities themselves. The vast majority of current AI poetry literature addresses the philosophical and technical questions: *Can machines write poetry? What are the characteristics of AI-generated verse? How does AI-generated poetry compare to human authorship?* (Ippolito et al., 2022). 

**This represents a critical gap**: While literary and computational communities debate whether AI can produce meaningful poetry, **language educators lack empirical understanding of how to configure AI as a pedagogical partner supporting L2 students' creative development**. Questions such as *How should AI be configured to scaffold authentic creative voice while supporting linguistic development?*, *What interaction types between students and AI systems promote deep engagement with poetic form and meaning?*, and *How do parameter configurations affect learner authorship and creative agency in L2 poetry contexts?* remain largely unexplored. 

**This study tries to address this pedagogical gap** by shifting focus from *AI-as-poet* to *AI-as-creative-pedagogue*—investigating not whether AI can write publishable poetry, but how educators can harness AI's structural understanding and generative capacity to support L2 students' own creative discovery and voice development. By examining how parameter configuration shapes interaction patterns and learning outcomes in authentic L2 poetry writing contexts, we contribute essential evidence for technology-mediated language pedagogy that current literature does not provide.
...
Twenty L2 (10 for primary experiment) English learners volunteered for this study, recruited from Hong Kong Baptist University's undergraduate population through course announcements and digital posters. All participants met CEFR B1-B2 proficiency criteria—intermediate English users capable of expressing themselves creatively while still grappling with linguistic constraints that make scaffolding valuable. Their ages ranged from 18 to 32, with Indian, Thai, Mandarin, and Cantonese L1 backgrounds reflecting Hong Kong's linguistic landscape. Randomly assigned participants to each experimental room, ensuring balanced representation across parameter conditions.
...
Setting the Stage - Participants logged into their assigned rooms, familiarized themselves with the chatbot interface. This brief orientation established technical comfort before creative work began.
...
2. **Interaction Type Coding**: Each AI response was independently classified by two trained coders following an operational coding scheme distinguishing three interaction types.
...
> "It's pretty obvious! On our lower temperature, ours took our words and tried to put it in poem form. Whereas comparing output from C and D... there's a lot of changes to the input format..." 
...
Post-session Feedbacks (N=9 respondents) revealed a striking paradox: 78% of participants (7/9) rated Type B (Exemplar Giving) as "most helpful", yet structured room participants who experienced predominantly Type B interactions reported dramatically lower authorship perception.
...
2. **Proposed parameter-task matching**:
   - A Room D participant (who became aware during debriefing) suggested optimal interaction type sequencing: "Type A and B are helpful in the beginning to generate ideas and refine your own writing, whereas Type C would be helpful in the end when you want to explore some other, perhaps, more creative options."
...
### 4.2 Why Type B Contradicts DDL Principles: Surface Learning vs. Deep Learning
...
The distinction between **surface and deep learning** (Marton & Säljö, 1976; Biggs, 1987) illuminates this contradiction more precisely. **Surface learning** occurs when learners focus on reproducing information or applying procedures mechanically—memorizing exemplars, selecting from preset options, mimicking models without engaging underlying principles. **Deep learning** occurs when learners interrogate patterns, understand relationships between concepts, and actively construct meaning. Type B interactions promote **surface-learning orientations** by presenting predetermined exemplars that learners can select and use without interrogating how the patterns work or why certain choices matter. Learners engage in **reproductive selection**—choosing from AI-provided alternatives—rather than **generative construction**—creating language in response to communicative intent. The cognitive process becomes pattern-application rather than pattern-discovery, reproductive fidelity rather than understanding relationships.

This helps explain why Type B, despite its immediate helpfulness, undermines the very outcomes creative writing pedagogy seeks to cultivate. Hanauer (2010) argues that L2 poetry writing's value lies in developing **authentic voice** and **creative agency**—capacities that require learners to struggle with expression, experiment with possibilities, and interrogate linguistic choices deeply enough to discover their linguistic-creative identity. **Surface-learning approaches** like Type B's exemplar selection **short-circuit this developmental process**. Learners may produce technically competent poems, but they do so through **reproductive curation**—selecting and assembling AI-generated components—rather than **generative creation**—constructing language through deep engagement with meaning-making. They internalize patterns at the surface level (recognizing good lines) without developing deep understanding of **how** language creates effects (why these lines work, when they might fail, what alternatives exist).

When AI pre-generates options, it **short-circuits the struggle central to creative learning**. Learners complete the task (task achievement) but bypass the transformative engagement that builds creative and linguistic competence (learning outcome). The poem produced may be technically superior to what the learner might have generated independently, but the learning value is diminished because minimal cognitive struggle or critical evaluation occurred. **Surface learning can produce successful performance in the moment; deep learning develops sustainable capacity**.

### 4.3 Type C Interactions as DDL-Compatible AI Collaboration
...
### 4.4 Answering Crosthwaite: Conditional Resolution

Crosthwaite (2023) asked whether AI would "do the work for learners," bypassing DDL's inductive engagement. Our findings provide conditional answer: **AI undermines or supports DDL principles depending on how we educators configure, prompt, and design pedagogical AI**.
...
- Make parameters visible, adjustable with pedagogical guidance;
...
Crosthwaite, P., & Baisa, V. (2023). Generative AI and the end of corpus-assisted data-driven learning? Not so fast! *Applied Corpus Linguistics*, *3*(3), 1-15.
